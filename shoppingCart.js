...
function updateCart(name, amount = 1) {
  // the problem with the original line of code that follows is that
  // if 0 is passed in as argument, as a falsy value it will always
  // result in amount be assigned to 1, which is not what we want.
  // We could use a ternary statement as below, or have a default 
