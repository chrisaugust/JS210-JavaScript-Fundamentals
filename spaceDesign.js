...
// We must use dot notation or bracket notation with strings for the property names
// when assigning values to properties. Otherwise, JS thinks we are referencing
// variables, and the objects assigned to previously declared variables ceo, developer,
// and scrumMaster will be converted to strings '[object Object]' and used as the property 
// name
//
// team[ceo] = 'Kim';
